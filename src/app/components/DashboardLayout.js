...
import {
  ...
  MenuIcon,
  CloseIcon,
} from '@/lib/icons'; // Add MenuIcon, CloseIcon
...
export default function DashboardLayout({ children, pageTitle = 'Dashboard' }) {
  ...
  return (
    <div
      className={`dashboard-container ${isMobileMenuOpen ? 'mobile-menu-active' : ''}`}
    >
      ...
      {/* Sidebar */}
      <div
        className={`sidebar ${isSidebarCollapsed ? 'collapsed' : ''} ${isMobileMenuOpen ? 'mobile-menu-open' : ''}`}
      >
        ...
        <nav className="sidebar-nav">
          <ul>
            ...
            <li>
              <Link
                href="/items"
                className={pageTitle === 'Items' ? 'active' : ''}
              >
            ...
            <li>
              <a
                href="/account"
                className={pageTitle === 'Account' ? 'active' : ''}
              >
                <AccountIcon />
      ...
      <div className={`main-content ${isSidebarCollapsed ? 'expanded' : ''}`}>
        ...
        <div className="topbar">
          <div className="topbar-left">
            ...
            {pageTitle === 'Items' && ( // Update condition
              <div className="search-container">
                <SearchIcon className="search-icon" />
                <input
                  type="text"
                  className="search-input"
                  placeholder="Search items..." // Update placeholder
                  onChange={(e) => {
                    // We'll pass this search term to the children components
                    if (typeof window !== 'undefined') {
                      const event = new CustomEvent('itemSearch', {
